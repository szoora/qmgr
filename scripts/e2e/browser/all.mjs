...
const SUITES = [
  ...
  'hub-nav', 'import-classes', 'import-reimport', 'import-wizard', 'list-sweep', 'localization', 'minutes-ui', 'mobile-nav', 'mobile-readiness', 'notification-bell', 'payments-ui', 'portal-tabs', 'profile-photo', 'register-and-duty-sheet',
